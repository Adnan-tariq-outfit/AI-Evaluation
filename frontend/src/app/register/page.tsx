    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="w-full max-w-md p-8 m-4 mx-auto bg-white rounded-2xl shadow-sm border border-zinc-200">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-600">Sign up to get started with NexusAI</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-start">
            ...
            />
            <label htmlFor="agreeToTerms" className="ml-2 text-sm text-zinc-600">
              I agree to the{' '}
              <Link href="/terms" className="text-[#84B179] hover:text-[#6f9766]">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link href="/privacy" className="text-[#84B179] hover:text-[#6f9766]">
                Privacy Policy
              </Link>
            </label>
          </div>
